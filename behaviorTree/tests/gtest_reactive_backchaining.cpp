...
public:
  ...
  BT::NodeStatus tick() override
  {
    ...
    return (val) ? NodeStatus::E_SUCCESS : NodeStatus::E_FAILURE;
  }
};
...
TEST(ReactiveBackchaining, EnsureWarm)
{
  ...
  EXPECT_EQ(tree.tickExactlyOnce(), NodeStatus::E_RUNNING);
  ...
  EXPECT_EQ(tree.tickExactlyOnce(), NodeStatus::E_SUCCESS);
