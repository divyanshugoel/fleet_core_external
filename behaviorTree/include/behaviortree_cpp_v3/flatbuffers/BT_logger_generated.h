...
{
    static const NodeStatus values[] = {NodeStatus::E_IDLE, NodeStatus::E_RUNNING, NodeStatus::E_SUCCESS, NodeStatus::E_FAILURE};
    return values;
}
...
{
    if (flatbuffers::IsOutRange(e, NodeStatus::E_IDLE, NodeStatus::E_FAILURE))
        return "";
...
{
    static const NodeType values[] = {NodeType::UNDEFINED, NodeType::ACTION, NodeType::CONDITION, NodeType::CONTROL, NodeType::DECORATOR, NodeType::SUBTREE};
    return values;
}

inline const char* const* EnumNamesNodeType()
{
    static const char* const names[7] = {"UNDEFINED", "ACTION", "CONDITION", "CONTROL", "DECORATOR", "SUBTREE", nullptr};
    return names;
}
...
{
    static const PortDirection values[] = {PortDirection::INPUT, PortDirection::OUTPUT, PortDirection::INOUT};
    return values;
}
...
public:
    StatusChange()
        : uid_(0), prev_status_(0), status_(0), padding0__(0), timestamp_()
    {
        (void)padding0__;
    }
    StatusChange(uint16_t _uid, Serialization::NodeStatus _prev_status, Serialization::NodeStatus _status, const Serialization::Timestamp& _timestamp)
        : uid_(flatbuffers::EndianScalar(_uid)), prev_status_(flatbuffers::EndianScalar(static_cast<int8_t>(_prev_status))), status_(flatbuffers::EndianScalar(static_cast<int8_t>(_status))), padding0__(0), timestamp_(_timestamp)
    {
        (void)padding0__;
    }
    uint16_t uid() const
...
struct PortModel FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_PORT_NAME) && verifier.VerifyString(port_name()) && VerifyField<int8_t>(verifier, VT_DIRECTION) && VerifyOffset(verifier, VT_TYPE_INFO) && verifier.VerifyString(type_info()) && VerifyOffset(verifier, VT_DESCRIPTION) && verifier.VerifyString(description()) && verifier.EndTable();
    }
};
    ...
    const char* type_info = nullptr, const char* description = nullptr)
{
    ...
    return Serialization::CreatePortModel(_fbb, port_name__, direction, type_info__, description__);
}
...
struct PortConfig FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_PORT_NAME) && verifier.VerifyString(port_name()) && VerifyOffset(verifier, VT_REMAP) && verifier.VerifyString(remap()) && verifier.EndTable();
    }
};
...
CreatePortConfig(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> port_name = 0, flatbuffers::Offset<flatbuffers::String> remap = 0)
{
...
inline flatbuffers::Offset<PortConfig>
CreatePortConfigDirect(flatbuffers::FlatBufferBuilder& _fbb, const char* port_name = nullptr, const char* remap = nullptr)
{
    auto port_name__ = port_name ? _fbb.CreateString(port_name) : 0;
...
struct TreeNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_UID) && VerifyOffset(verifier, VT_CHILDREN_UID) && verifier.VerifyVector(children_uid()) && VerifyField<int8_t>(verifier, VT_STATUS) && VerifyOffsetRequired(verifier, VT_INSTANCE_NAME) && verifier.VerifyString(instance_name()) && VerifyOffsetRequired(verifier, VT_REGISTRATION_NAME) && verifier.VerifyString(registration_name()) && VerifyOffset(verifier, VT_PORT_REMAPS) && verifier.VerifyVector(port_remaps()) && verifier.VerifyVectorOfTables(port_remaps()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<TreeNode> CreateTreeNodeDirect(
    ...
    Serialization::NodeStatus status = Serialization::NodeStatus::E_IDLE,
    ...
    const std::vector<flatbuffers::Offset<Serialization::PortConfig>>* port_remaps = nullptr)
{
    ...
    auto port_remaps__ = port_remaps ? _fbb.CreateVector<flatbuffers::Offset<Serialization::PortConfig>>(
                             *port_remaps)
                                     : 0;
    return Serialization::CreateTreeNode(_fbb, uid, children_uid__, status, instance_name__, registration_name__, port_remaps__);
}
...
struct NodeModel FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_REGISTRATION_NAME) && verifier.VerifyString(registration_name()) && VerifyField<int8_t>(verifier, VT_TYPE) && VerifyOffset(verifier, VT_PORTS) && verifier.VerifyVector(ports()) && verifier.VerifyVectorOfTables(ports()) && verifier.EndTable();
    }
};
...
CreateNodeModel(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> registration_name = 0, Serialization::NodeType type = Serialization::NodeType::UNDEFINED, flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Serialization::PortModel>>> ports = 0)
{
...
struct BehaviorTree FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ROOT_UID) && VerifyOffset(verifier, VT_NODES) && verifier.VerifyVector(nodes()) && verifier.VerifyVectorOfTables(nodes()) && VerifyOffset(verifier, VT_NODE_MODELS) && verifier.VerifyVector(node_models()) && verifier.VerifyVectorOfTables(node_models()) && verifier.EndTable();
    }
};
...
struct StatusChangeLog FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_BEHAVIOR_TREE) && verifier.VerifyTable(behavior_tree()) && VerifyOffset(verifier, VT_STATE_CHANGES) && verifier.VerifyVector(state_changes()) && verifier.EndTable();
    }
};
...
inline void
FinishBehaviorTreeBuffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<Serialization::BehaviorTree> root)
{
    fbb.Finish(root);
}
